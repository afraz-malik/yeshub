                    ...
                    <div style="padding: 40px 20px;">
                        <h1 style="margin-bottom: 20px; font-stretch: normal; font-size: 13px; line-height: normal;
                            font-family: Times; color: #1c1e21; "><span style="font-size: 24pt; font-family: arial,
                                helvetica, sans-serif; color: #236fa1; ">Welcome to YES!HUB</span></h1>
                        ...
                        <p style="margin-bottom: 20px; font-stretch:
                            normal; font-size: 13px; line-height: normal; font-family: Times; color: #1c1e21; "><span
                                ...
                                signing up to YES!HUB, the one-stop shop for practitioners and partners in youth
                                employment and entrepreneurship</span></p>
                        ...
                        <p style="margin-bottom: 0px; font-stretch: normal; font-size: 13px; line-height: normal;
                            font-family: Times; color: #1c1e21; "><span style="font-family: arial, helvetica,
                                ...
                                below:</span></p>
                                <a style="margin-bottom: 20px;" href="${link}">Verify Account</a>
                                
                        <p style="margin-bottom: 20px; font-stretch: normal;
                            font-size: 13px; line-height: normal; font-family: Times; color: #1c1e21; "><span
                                style="font-size: 12pt; font-family: arial, helvetica, sans-serif; ">You will be
                                redirected to Settings, where you are highly encouraged to provide a little bit more
                                information about you so we can serve you and the Community better. Speaking of
                                Communities, we invite you to join all the ones you&rsquo;re interested in so they can
                                be added to your feed.</span></p>
                        <p style="margin-bottom: 50px; font-stretch: normal; font-size: 13px; line-height: normal;
                            font-family: Times; color: #1c1e21; "><span style="font-size: 12pt; font-family: arial,
                                helvetica, sans-serif; "> Browse events, see our Solutions, check back once in a while
                                to see new content, and contribute your own! </span></p>
                        <p style="margin-bottom: 0px;
                            ...
                            #1c1e21; "><span style="font-size: 12pt; font-family: arial, helvetica, sans-serif; ">At
                                your service,</span></p>
                                <img style="margin-top: 7px; margin-left: -3px; height: 25px;" src="https://uat.hub.yesdigital.org/static/media/yeshub.a5f20770.png" alt="">
                    </div>
