module.exports = function (
    ...
    Message,
    user,
    email = "yes-hub@plan-international.org"
) {
    return `<!DOCTYPE html
...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #FFFFFF;">
                    ...
                    <div>
                        ...
                        <p style="margin-bottom: 20px; font-stretch:
                            normal;font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: normal; color: #1c1e21; "><span
                                style="font-size: 18pt; color: #7e8c8d; "><strong>Dear ${user.userName}</strong></span></p>
                        ...
                        <p style="margin-bottom: 0px; font-stretch: normal; font-size: 13px; line-height: normal;
                            font-family: Times; color: #1c1e21; "><span style="font-family: arial, helvetica,
                                sans-serif; font-size: 12pt; ">${Message}</span>
                                
                                <p style="margin-bottom: 20px; font-stretch: normal;
                            font-size: 13px; line-height: normal; font-family: Times; color: #1c1e21; ">
                            <span
                                style="font-size: 10pt; font-family: arial, helvetica, sans-serif; ">
                                   With kind regards,</span></p>
                                   <p style="margin-bottom: 20px; font-stretch: normal;
                            font-size: 13px; line-height: 1px; font-family: Times; color: #1c1e21; ">
                            <span
                                style="font-size: 10pt; font-family: arial, helvetica, sans-serif; ">
                                   YES!HUB Team</span></p>
                        ...
                        <p style="margin-bottom: 20px; font-stretch: normal;
                            font-size: 13px; line-height: normal; font-family: Times; color: #1c1e21; ">
                            <span
                                style="font-size: 8pt; font-family: arial, helvetica, sans-serif; ">If you did not request this, kindly alert us at <a href = "mailto: ${email}">
                                    ${email}
                                </a></span></p>
    ...
    //                                 helvetica, sans-serif; color: #236fa1; ">Alert</span></h1>

    //                         <p style="margin-bottom: 20px; font-stretch:
    //                             normal;font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: normal; color: #1c1e21; "><span
    //                                 style="font-size: 18pt; color: #7e8c8d; "><strong>Hi,</strong></span></p>
    ...
    //                                 style="font-size: 12pt; font-family: arial, helvetica, sans-serif; ">If you did not request this, kindly alert us at <a href = "mailto: ${email}">
    //                                     ${email}
    //                                 </a></span></p>
